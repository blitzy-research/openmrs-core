...
This product is licensed under the Mozilla Public License 2.0 with Healthcare Disclaimer. See the [LICENSE](LICENSE) file for details.
...
The following are internal OpenMRS components licensed under the [Mozilla Public License 2.0 with Healthcare Disclaimer](https://openmrs.org/license):
